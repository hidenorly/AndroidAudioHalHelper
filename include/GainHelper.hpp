...
{
public:
  static float getAmplifierRatioFromDb(float gainDb);
  static float getVolumeRatioPercentageFromDb(float gainDb, float minVolumePercent=FLT_MIN, float maxVolumePercent=FLT_MAX);
