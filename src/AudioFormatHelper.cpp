...
AudioFormat::CHANNEL AndroidEncodingHelper::getChannelFromAndroidChannel(uint32_t androidChannel)
{
...
int AndroidEncodingHelper::getAndroidChannelFromChannel(AudioFormat::CHANNEL afwChannel)
{
